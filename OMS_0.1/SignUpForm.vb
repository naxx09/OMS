...
Public Class SignUpForm
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        'for employee, they should not create manager or CEO account
    ...
    Private Sub AddCustomer()
        ...
        Else
            ...
            DB.ExecuteQuery("INSERT INTO employee(username, password, supervisor_ID, position, firstname, lastname, DOB, address, phone, date_hired, email, state, city) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)")
    ...
    Private Sub EmployeeCancelButton_Click_1(sender As Object, e As EventArgs) Handles EmployeeCancelButton.Click
